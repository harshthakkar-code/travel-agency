...
//     setErrors(prev => {
//       const updated = { ...prev };
//       if (updated[e.target.name]) delete updated[e.target.name];
//       return updated;
//     });
//   };
...
//         style={{ maxWidth: "500px" }} // slightly wider popup
//       >
//         <form
...
//           <p className="form-subtitle" style={{fontWeight: "bold"}}>Please enter your details to register.</p>
