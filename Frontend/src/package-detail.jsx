...
const Package_detail = () => {
  ...
  useEffect(() => {
    const fetchPackage = async () => {
      try {
        // If your endpoint is /packeg/:id, note the correct spelling
                    ...
                    <div className="tab-content" id="myTabContent">
                      ...
                      <div className="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview-tab">
                        <div className="overview-content">
                          ...
                          {/* You can map more details or features here if your API supports */}
                        </div>
                      </div>
                      {/* Program */}
                      <div className="tab-pane" id="program" role="tabpanel" aria-labelledby="program-tab">
                        <div className="itinerary-content">
                          ...
                          {/* Optionally place itinerary/steps if provided in API */}
                          <p>
                            {pkg.program || "No program details provided."}
                          </p>
                        </div>
                        {/* Optionally list program days/steps if provided */}
                      </div>
                      {/* Review */}
                      <div className="tab-pane" id="review" role="tabpanel" aria-labelledby="review-tab">
                        {/* Place review logic here as needed (static or from API) */}
                        <div className="summary-review">
                          <div className="review-score">
                        ...
                        {/* ...Static review content unchanged... */}
                      </div>
                      {/* Map */}
                      <div className="tab-pane" id="map" role="tabpanel" aria-labelledby="map-tab">
                        <div className="map-area">
              ...
              <div className="col-lg-4">
                <div className="sidebar">
                  <div className="package-price">
                    ...
                    {/* ...rest of static sidebar unchanged... */}
                    <div className="start-wrap">
                      <div className="rating-start" title="Rated 5 out of 5">
                  ...
                  {/* ...static booking and info widgets unchanged... */}
                  <div className="widget-bg booking-form-wrap">
                    <h4 className="bg-title">Booking</h4>
                    <form className="booking-form">
                      ...
                      <div className="row">
                        ...
                        {/* ...checkbox options in original code remain unchanged... */}
                        <div className="col-sm-6">
                          <div className="form-group">
                            <label className="checkbox-list">
                              <input type="checkbox" name="s" />
