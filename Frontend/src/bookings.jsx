      ...
      >
        {selectedBooking && (
          <div>
            ...
            <div>
              <strong>User:</strong> {selectedBooking.user.fullName}<br/>
              <strong>Email:</strong> {selectedBooking.user.email}<br/>
              <strong>Phone:</strong> {selectedBooking.user.phone}<br/>
              <strong>Destination:</strong> {selectedBooking.package.destination}<br/>
              <strong>Package Title:</strong> {selectedBooking.package.packageTitle}<br/>
              <strong>Travel Date:</strong> {new Date(selectedBooking.package.travelDate).toLocaleDateString()}<br/>
              <strong>Group Size:</strong> {selectedBooking.package.groupSize}<br/>
              <strong>Trip Duration:</strong> {selectedBooking.package.tripDuration}<br/>
              <strong>Status:</strong> {selectedBooking.status}<br/>
              <strong>Booking Date:</strong> {new Date(selectedBooking.bookingDate || selectedBooking.createdAt).toLocaleDateString()}<br/>
              <strong>Pricing Details:</strong><br/>
              &nbsp;- Package Cost: ${(selectedBooking.pricing.packageCost ).toFixed(2)}<br/>
              &nbsp;- Tour Guide: ${(selectedBooking.pricing.tourGuide ).toFixed(2)}<br/>
              &nbsp;- Meals Included: ${(selectedBooking.pricing.mealsIncluded ).toFixed(2)}<br/>
              &nbsp;- Extra Baggage: ${(selectedBooking.pricing.extraBaggage ).toFixed(2)}<br/>
              &nbsp;- Transfers: ${(selectedBooking.pricing.transfers ).toFixed(2)}<br/>
              &nbsp;- Tax Rate: {selectedBooking.pricing.taxRate}<br/>
              &nbsp;- Total Cost: ${(selectedBooking.pricing.totalCost).toFixed(2)}<br/>
            </div>
          </div>
        )}
      </Modal> */}
...
>
  {selectedBooking && (
    <div>
      {/* Close button as cross in top right */}
      <button
        onClick={closeModal}
        style={{
          position: "absolute",
      ...
      <div style={{ marginTop: "20px" }}>
        ...
        <ul style={{ listStyle: "none", paddingLeft: 0 }}>
          ...
          {/* <li>Tax Rate: {selectedBooking.pricing.taxRate}</li> */}
