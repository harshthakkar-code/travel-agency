    ...
    <main id="content" className="site-main">
      ...
      <div className="archive-section blog-archive">
        <div className="archive-inner">
          <div className="container">
            <div className="row">
              {/* --- Blog Posts (Left, but order-md-12 for responsive) --- */}
              <div className="col-lg-8 order-md-12 primary left-sidebar">
...
export default BlogArchiveLeft;
